...
int main(void)
{
    ...
    // Load the shader
    Shader shader = LoadShaderEx(TextFormat("examples/shaders/resources/shaders/glsl%i/base.vs", GLSL_VERSION),
                               TextFormat("examples/shaders/resources/shaders/glsl%i/rounded_rectangle.fs", GLSL_VERSION), 9, uniforms);
