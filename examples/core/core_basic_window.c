...
int main(void)
{
    ...
    Model model = LoadModel("examples/models/resources/models/obj/castle.obj");                 // Load model
    Texture2D texture = LoadTexture("examples/models/resources/models/obj/castle_diffuse.png"); // Load model texture
